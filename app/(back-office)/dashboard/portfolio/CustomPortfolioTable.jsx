...
// import {Pen}
export default function CustomPortfolioTable() {
   ...
   const endpoint = "api/v1/portfolio"; // Replace 'your-endpoint' with the actual endpoint
                ...
                return (
                  ...
                  >
                    ...
                    <td className="flex gap-4 px-6 py-4">
                      <Link href={`/dashboard/portfolio/update/${item._id}`}>
