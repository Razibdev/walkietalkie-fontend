                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingOne">
                                        <button className="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span className="title">What payment methods do you accept?</span><i
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingTwo">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span className="title">How long will delivery take?</span><i className="lni lni-plus"></i>
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingThree">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span className="title">Do I need an account to place an order?</span><i
                                                className="lni lni-plus"></i>
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingFour">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span className="title">Do you have discounts for returning customers?</span><i
                                                className="lni lni-plus"></i>
                                        </button>
                                    </h2>
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingFive">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span className="title">What are the product refund conditions?</span><i
                                                className="lni lni-plus"></i>
                                        </button>
                                    </h2>
